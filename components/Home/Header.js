          ...
          <div className=" flex flex-wrap flex-row items-center sm:px-2 ">
            <div className="w-full lg:w-[40%]  my-8 mt-10 lg:mt-16">
              ...
              <h1 className="mb-3 text-4xl font-bold leading-snug text-dark sm:text-[42px] lg:text-[40px] xl:text-[42px]">
                Innovative solutions for your eye health.
              </h1>
              ...
              <div className="flex flex-wrap -m-2.5 lg:mb-20">
                <div className="w-full md:w-auto p-2.5">
                  <div className="block">
                    <button
                      className="py-4 px-5 w-full text-white font-semibold border border-indigo-700 rounded-xl focus:ring focus:ring-indigo-300 bg-indigo-600 hover:bg-indigo-700 transition ease-in-out duration-200"
                      type="button"
                    >
                      {" "}
                      Book Appointment
