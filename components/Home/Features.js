...
import homeservices from "../../public/src/images/homeservices.jpg"

const Features = () => {
    return (
        <div className="overflow-hidden py-20 sm:py-10 lg:mt-10 ">
            <div className="mx-auto max-w-7xl px-6 lg:px-14 sm:px-5">
                <div className="mx-auto grid sm:px-5 grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                        ...
                        <div className="lg:max-w-lg">
                            ...
                            <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-600 lg:max-w-none">
                                <div className="relative pl-9">
                                    ...
                                    <dd className="inline">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit perferendis.</dd>
                                </div>
                    ...
                    <div className=" w-full video items-center justify-between m-auto lg:p-20">
