...
const Header2 = () => {
  ...
  return (
    <div className="overflow-hidden relative bg-gray-900">
            ...
            <div className="flex flex-col items-center justify-between xl:flex-row">
              <div className="w-full max-w-xl mb-12 xl:pr-16 xl:mb-0 xl:w-7/12">
                  ...
                  <div class="flex flex-wrap items-center -m-1">
                    <div className=" p-1">
                      <a className="text-sm" href="">
                        &#x1F44B; Your Eyes is your window to the world.
                      </a>
                    </div>
                    <div className=" p-1">
                      <svg
                ...
                <p className="max-w-xl mb-4 text-base text-gray-400 md:text-base">
                  ...
                  solutions with innovative and up to date clinical practices,
                  in a friendly and conducive environment.
                </p>

                <button
                  className="py-4 px-5 w-fit text-white font-semibold border border-indigo-700 rounded-xl focus:ring focus:ring-indigo-300 bg-indigo-600 hover:bg-indigo-700 transition ease-in-out duration-200"
                  type="button"
                >
                  {" "}
                  Book Appointment
      ...
      <div
        className="absolute right-20 top-0 -z-10 -translate-x-1/2 blur-3xl xl:-top-6"
        aria-hidden="true"
      >
        <div
