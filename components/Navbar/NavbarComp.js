        ...
        <header className=" bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-100 border-b inset-x-0 top-0 z-50 px-6 sm:px-7">
          <nav className="flex items-center justify-between py-4">
            ...
            <div className="hidden lg:flex gap-10 items-center lg:justify-end">
              ...
              <Link
                href="/contact"
                className=" py-3 px-5 w-fit text-white font-semibold border border-indigo-700 rounded-xl focus:ring focus:ring-indigo-300 bg-indigo-600 hover:bg-indigo-700 transition ease-in-out duration-200"
                type="button"
              >
              ...
              <div className="mt-6 flow-root">
                <div className="-my-6 divide-y divide-gray-500/10">
                  ...
                  <div className="py-6">
                    <Link
                      href="/contact"
                      className=" rounded-lg bg-blue-600 py-3 px-2 text-center text-base font-normal text-white hover:bg-opacity-90 sm:px-10 lg:px-4 xl:px-4"
                    >
                      Contact us <span aria-hidden="true">&rarr;</span>
                    </Link>
                  </div>
