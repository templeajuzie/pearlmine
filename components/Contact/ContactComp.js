const ContactComp = () => {
    return ( 
        <div className="gen">
            <div className="relative z-10 overflow-hidden bg-white py-20 lg:py-[80px] lg:px-5 sm:pt-20">
                <div className="container mx-auto">
                    <div className="-mx-4 flex flex-wrap lg:justify-between px-5">
                        <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                            <div className="mb-12 max-w-[500px] lg:mb-0 ">
                                ...
                                <p className="mb-9 text-base leading-relaxed text-body-color">
                                    We{`'`}re here to answer any questions you may have about our services, schedule appointments, and provide assistance.
                                </p>
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-base text-body-color">+234(0)7058319578</p>
                                        <p className="text-base text-body-color">+234(0)8039243759</p>
                                        <p className="text-base text-body-color">+234(0)7059296154</p>
                                    </div>
                                </div>
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        <h4 className="mb-1 text-xl font-bold text-dark">Opening Hours</h4>
                                        <p className="text-base text-body-color">8:30am – 5pm (Monday – Friday)</p>
                                        <p className="text-base text-body-color">10am – 3pm (Saturday)</p>
                                    </div>
                                </div>
                                ...
                                <div className="mb-8 flex w-full max-w-[370px]">
                                    ...
                                    <div className="w-full">
                                        ...
                                        <p className="text-base text-body-color">info@pearlmineyecare.ng</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="w-full px-4 lg:w-1/2 xl:w-5/12 ">
                            <div className="relative rounded-lg bg-white p-8 shadow-lg sm:p-12 lg:mr-8">
