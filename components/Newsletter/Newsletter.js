                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
                        <div className="max-w-xl lg:max-w-lg">
                            <h2 className="text-xl font-bold tracking-tight text-black sm:text-4xl">Subscribe to our newsletter.</h2>
                            ...
                            <div className="mt-6 flex max-w-md gap-x-4">
                                ...
                                <input
                                    ...
                                    autoComplete="email"
                                    required
                                    className="min-w-0 flex-auto rounded-md border-0 bg-gray/5 px-3.5 py-2 text-black shadow-sm ring-1 ring-inset ring-blue/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"
